...
const Portafolio = () =>{
    ...
    return(
        <>
            <div id='portafolio' className='bg-[#F6F6F6] w-5/6 m-auto flex flex-col items-center'>
                ...
                <div className='flex flex-col gap-3 w-full px-2 md:w-3/4 md:flex-row justify-between mb-10'>
